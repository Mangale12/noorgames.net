...
public function tableop()
{
    ...
    public function spinner()
    {
        ...
        if($appFeatures['projectFeature']['spinner'] == 1){
    ...
    // dd($filter_start);
            ...
            return view('newLayout.layouts.access_denied');
        }
...
//                     echo date($date_2);
    ...
    public function gamerGamesMonth($id="all")
    {
    ...
    public function settings(){
        ...
        $settings = GeneralSetting::first()->toArray();
        return view('newLayout.settings',compact('settings','appFeatures'));
    }
   public function settingStore(Request $request){
        ...
        try
        {
            $gamers_games = $request->only('gamersgames_mail_day', 'gamersgames_mail_time','gamersgames_mail_message', 'gamers_games_mail');
            // dd($gamers_games);
            $settings = GeneralSetting::where('id',1)->update([
                ...
                'gamers_games'=>json_encode($gamers_games),
