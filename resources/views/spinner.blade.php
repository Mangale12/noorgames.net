...
<html lang="en">
   ...
   <body>
      ...
      <!-- The Modal -->
      <div id="myModal d-none" class="modal">
         <!-- Modal content -->
         <div class="modal-content rainbow">
            ...
            <div id="modal_main_content" style="font-size:18px">
               <center>
                  ...
                  {{--
                  <p class="neon-text neon_planetdisplay"></p>
                  Congratulations
                  <text id='winnerinfolaters' style="font-weight:bold"></text>
                  , you have won the first monthly spinner of noor games<br><br>
                  ...
                  <p class="neon-text neon_planetdisplay">
                     Congratulations
                     <text id='winnerinfolaters' style="font-weight:bold"></text>
                     you have won the monthly spinner of noor games
                  </p>
                  <p class="neon-text neon_planetdisplay">
                     Please reach out to <b>Sasha</b> at messenger for payout with screenshot of win
                  </p>
                  <p class="neon-text neon_planetdisplay">Sincerely</p>
                  <p class="neon-text neon_planetdisplay">Noor Games</p>
                  <br>
               </center>
            </div>
         </div>
      ...
      <div id="welcome_container" style="top: -156px; position: relative; right: -438px; width: 240px;>
         <div id="timer">
            NEXT SPIN IN
            <hr>
            <text id="countdown" class="neon-text2" style="font-size:16px;"> Loading..</text>
      ...
      <div class="aside_winners d-none">
