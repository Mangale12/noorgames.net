                ...
                <div class="d-flex px-3">
                    <div class="d-flex  justify-content-center text-center">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="left: -75px!important;">
                            ...
                            <a class="dropdown-item remove-form-game" href="javascript:void(0);" data-tr="{{$counts+1}}" data-type="load" data-userId="{{$num['form']['id']}}" data-game="{{$activeGame['id']}}"> Remove</a>
