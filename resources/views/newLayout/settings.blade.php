...
<div class="container">
    @php
    // $gameregames = json_decode($settings['gamers_games'], true);
    @endphp
         ...
         <form action="{{ route('settingStore') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card mt-5">
               <ul class="nav nav-tabs" id="myTab" role="tablist">
                   <li class="nav-item">
                     <a class="nav-link active" id="general-setting-tab" data-toggle="tab" href="#general-setting" role="tab" aria-controls="general-setting"
                        aria-selected="true">General Settings</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link " id="spinner-tab" data-toggle="tab" href="#spinner" role="tab" aria-controls="spiner"
                        aria-selected="false">Spiner</a>
                  </li>
                  <li class="nav-item">
               ...
               <div class="card-body">
                  <div class="tab-content" id="spinnerd">
                     <div class="tab-pane fade " id="spinner" role="tabpanel" aria-labelledby="spinner">
                        <div class="card mt-5">
                           <div class="card-header" style="padding-bottom:0">
                              <h5>Spiner Time</h5>
                           </div>
