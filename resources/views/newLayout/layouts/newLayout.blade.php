                    ...
                    <div class="menu-list">
                        ...
                        <ul id="menu-content" class="menu-content collapse out">
                            ...
                            <ul class="sub-menu collapse" id="products">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->segment(1) == 'redeemHistoryGreater' ? 'active' : '' }}"
                                        href="{{ route('redeemHistoryGreater') }}">
                                        <div
                                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                            <i class="fa fa-history text-warning text-sm opacity-10"></i>
                                        </div>
                                        <span class="nav-link-text ms-1">Redeems 1000</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->segment(1) == 'redeemHistorMissing' ? 'active' : '' }}"
                                        href="{{ route('redeemHistorMissing') }}">
                                        <div
                                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                            <i class="fa fa-history text-warning text-sm opacity-10"></i>
                                        </div>
                                        <span class="nav-link-text ms-1">Redeems Missing Users</span>
                                    </a>
                                </li>
                                @endif
