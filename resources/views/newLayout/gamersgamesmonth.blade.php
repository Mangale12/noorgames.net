...
@php
    ...
    $between_text = json_decode($settings['between_limit_text'],true);
        ...
        <div class="card-body">
            ...
            @if ($spinner_message == 1)
               <a  class="btn  btn-primary mb-0" style="background-color:#FF9800;"  href="#popup3" style="color:white;">Send Mail</a>
                    ...
                    <div class="popup">
                        ...
                        <div class="content ">
                          <form action="{{route('send-message')}}" method="post">
                              @csrf
                              <input name="id" type="hidden" value="1" class="form-id">
                              ...
                              <div class="form-group">
                                <label for="cars">Message</label>
                                  @if ((request()->segment(2) == 'above-'.$limit_amount))
                                      <textarea name="message" id="cars" class="form-control" placeholder="write your message">{{$above_limit_text['above_limit_text_1']}} {user name} {{$above_limit_text['above_limit_text_2']}}</textarea>
                                  @elseif((request()->segment(2) == 'between'))
                                      <textarea name="message" id="cars" class="form-control" placeholder="write your message">{{$between_text['between_limit_text_1']}}, {{$between_text['between_limit_text_2']}}</textarea>
                                  @else
                                      <textarea name="message" id="cars" class="form-control" placeholder="write your message">{{$below_limit_text['below_limit_text_1']}}, {{$below_limit_text['below_limit_text_2']}},</textarea>
                                  @endif
                              </div>
                  ...
                  <p>This Data is  Between {{$third_filter_start}} && {{$filter_end}}</p>
              @endif
            @endif
        </div>
    </div>
