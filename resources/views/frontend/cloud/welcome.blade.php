...
<head>
    ...
    animation: glowing 1300ms infinite;
        ...
        html {
    background-image: -webkit-linear-gradient(hsla(240,75%,75%,.6), hsla(300,75%,75%,.2))!important;
    /* font-size: 100%; */
    min-height: 100%;
}
...
<body>
    <div class="wrapper wow" style="height: 209vh!important;">
            ...
            <div class="page-wrapper font-robo" >
                <div class="wrapper wrapper--w680" >
                    ...
                    <div class="card card-1 py-5" style="top:75px;">
                        ...
                        <!--</div>-->
                        <div>
                            <h2 class="font-weight-bold text-center main-header-text welcome-font">                        
                                WELCOME TO THE NOOR GAMES
                            </h2>
                        </div>
                        <div class="mt-5 mx-5 text-center">
                            <h3 style="line-height:2rem;">
                                <span class="neon-text font-weight-bold blink welcome-font">Complete the registration process and start getting your bonus and rewards</span>. 
                            </h3>
                            <h4 class="mt-4">
