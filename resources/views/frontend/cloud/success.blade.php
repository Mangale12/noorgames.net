...
<body>
    ...
    <div class="wrapper wow" style="margin-bottom: -45px!important;">
      {{-- <video autoplay muted loop id="myVideo">
      <source src="{{url('images/fin.mp4')}}" type="video/mp4">
      Your browser does not support HTML5 video.
      </video> --}}
      <div id="clouds" >
        <div class="page-wrapper font-robo mt-1">
            <div class="wrapper wrapper--w680">
                <div class="card card-1 py-5">
                  ...
                  <div>
                        ...
                        <h2 class="font-weight-bold text-center main-header-text font-effect-neon welcome-font">
                    ...
                    <div class="card-body p-5">
                        <div class = "text-left">
                            <h3 style="line-height:2rem;">
                                    <span class="neon-text font-weight-bold blink font-effect-fire" style="font-family: Sofia, sans-serif;
                                    font-size: 30px;">Registration completed <br> Stay connected with Noor Games for much exciting bonus</span><span class="just-neon"> & </span><span class="neon-text font-weight-bold">reward</span>.
                            </h3>
                            <h4 class="mt-4">
