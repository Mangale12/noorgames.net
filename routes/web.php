...
Route::get('/', function () {
    ...
    switch($theme) {
        ...
        default:
            return view('frontend.default.welcome');
    }
    // return view('welcome');
})->name('homePage');
...
Route::post('check-refferer', [FormController::class, 'checkReffer'])->name('refferer.check');
...
Route::get('/gamers-games/{id}', [App\Http\Controllers\NewHomeController::class, 'gamerGames'])->name('gamersgames.previousmanth');
...
Route::post('/control/spinner',[HomeController::class, 'superadmin'])->name('superadmin.spinner')->middleware("auth");
