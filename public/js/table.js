        ...
        $('.referInput').on('keydown', function(e) {
            ...
            if (e.which === 13) {
                ...
                if (amount > currentGameBalance) {
                    ...
                    var type = "POST";
                    var ajaxurl = '/noor/table-referBalance?date='+dateCustom;
                    var interval = null;
                    $.ajax({
                        type: type,
                        url: ajaxurl,
    ...
    $(function() {
        ...
        // console.log(dateCustom);
                if (amount > currentGameBalance) {
                    ...
                    var type = "POST";
                    var ajaxurl = '/noor/table-loadBalance?date='+dateCustom;
                    var interval = null;
                    $.ajax({
                        type: type,
                        url: ajaxurl,
    ...
    $(function() {
        $('.redeemInput').on('keydown', function(e) {
            ...
            if (e.which === 13) {
                ...
                var type = "POST";
                var ajaxurl = '/noor/table-redeemBalance?date='+dateCustom;
                var interval = null;
                $.ajax({
                    type: type,
                    url: ajaxurl,
    ...
    $(function() {
        $('.tipInput').on('keydown', function(e) {
            if (e.which === 13) {
                ...
                var type = "POST";
                var ajaxurl = '/noor/table-tipBalance?date='+dateCustom;
                var interval = null;
                $.ajax({
                    type: type,
                    url: ajaxurl,
